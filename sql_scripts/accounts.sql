INSERT INTO ACCOUNTS_ACCOUNT (ID,USERNAME,PASSWORD,BIRTHDAY,GENDER,UNITS,EMAIL,ACTIVE_SINCE) VALUES (0,'admin','abcd',NULL,NULL,NULL,'betteru.webmaster@gmail.com',TO_DATE('24-OCT-13','DD-MON-RR'));
