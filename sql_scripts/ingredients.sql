...
--------------------------------------------------------
REM INSERTING into INGREDIENTS_INGREDIENT
SET DEFINE OFF;
...
INSERT INTO INGREDIENTS_INGREDIENT (ID,NAME,BRAND_ID,CATEGORY_ID,DEFAULT_SERVING_SIZE,DEFAULT_SERVING_UNIT,ALT_SERVING_SIZE,ALT_SERVING_UNIT,CALORIES,FAT,CARBOHYDRATES,PROTEIN) VALUES (4,'0% Greek Yogurt (Plain)',21,2,227,'g',0,'unknown',140,0,9,23);
...
INSERT INTO INGREDIENTS_INGREDIENT (ID,NAME,BRAND_ID,CATEGORY_ID,DEFAULT_SERVING_SIZE,DEFAULT_SERVING_UNIT,ALT_SERVING_SIZE,ALT_SERVING_UNIT,CALORIES,FAT,CARBOHYDRATES,PROTEIN) values (9,'Whole Grain Oats',10,1,1,'c',40,'g',150,3,27,5);
